...
namespace BleHid
{
    ...
    public class MouseTouchpad : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        [SerializeField] public RectTransform touchpadArea;
        [SerializeField] public Image touchpadBackground;
        [SerializeField] public Color normalColor = new Color(0.8f, 0.8f, 0.8f, 0.5f);
        [SerializeField] public Color activeColor = new Color(0.6f, 0.6f, 0.6f, 0.7f);
