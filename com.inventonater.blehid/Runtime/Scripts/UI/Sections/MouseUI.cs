...
{
    public class MouseUI : SectionUI, IInputSource
    {
        ...
        public MouseUI(MouseBridge mouse)
        {
            _mouse = mouse;
            ...
            _bindingList = GameObject.FindObjectOfType<BindingList>();
        ...
        private void DrawMouseButtons()
        {
            ...
            if (GUILayout.Button("Switch Mapping")) _bindingList.CycleNextBinding(_inputRouter.Binding);
            UIHelper.EndSection();
        }
